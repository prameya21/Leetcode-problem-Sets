...
public class AmazonFreshPromotion
{
    ...
    public void test(String[][] cl, String[] sc, int expect)
    {
        List<List<String>> codeList=new ArrayList<>();
        for(String[] str:cl)
            codeList.add(Arrays.asList(str));
        List<String> shoppingCart=new ArrayList<>(Arrays.asList(sc));
        System.out.println(checkWinner(codeList, shoppingCart) == expect);
    }

    public static void main(String[] args)
    {
        // test cases
        AmazonFreshPromotion obj=new AmazonFreshPromotion();
        ...
        // test
        obj.test(codeList1, shoppingCart1, 1);
        obj.test(codeList2, shoppingCart2, 0);
        obj.test(codeList3, shoppingCart3, 0);
        obj.test(codeList4, shoppingCart4, 0);
        obj.test(codeList5, shoppingCart5, 1);
        obj.test(codeList6, shoppingCart6, 1);
        obj.test(codeList7, shoppingCart7, 1);
        obj.test(codeList8, shoppingCart8, 1);
        obj.test(codeList9, shoppingCart9, 1);
    }
}
