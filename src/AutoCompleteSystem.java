...
public class AutoCompleteSystem
{
    ...
    Trie root=new Trie();
    String prefix="";
    public void insert(Trie node, String s, int time)
    {
    ...
    {
        AutoCompleteSystem obj=new AutoCompleteSystem(new String[]{"i love you", "island","ironman", "i love leetcode"},new int[] {5,3,2,2});
