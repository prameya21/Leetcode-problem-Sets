...
public class MaximumSumObtainedPermutations
{
    /*
    ...
    {
        MaximumSumObtainedPermutations obj=new MaximumSumObtainedPermutations();
        System.out.println(obj.maxSumRangeQuery(new int[]{1,2,3,4,5,10},new int[][]{{0,2},{1,3},{1,1}}));
    }
