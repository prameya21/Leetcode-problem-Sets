public class MinMaxProdDistribution
{
    /*
    ...
    public boolean helper(int x, int[] nums, int n)
    {
        int j=0;
        int curr=nums[j];
        for(int i=0;i<n;i++)
