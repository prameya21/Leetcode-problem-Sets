...
public class MinimumArrowsToBurstBalloons
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(obj.findMinArrowShots(new int[][]{{1,2},{3,4},{5,6},{7,8}}));
        System.out.println(obj.findMinArrowShots(new int[][]{{1,2},{2,3},{3,4},{4,5}}));
        System.out.println(obj.findMinArrowShots(new int[][]{{-1,1},{0,1},{2,3},{1,2}}));
