...
// Class to represent a Graph1
class Graph1
{

    // An array representing the Graph1 as an adjacency list
    ...
    // function to add an edge to Graph1
    ...
    // prints a Topological Sort of the complete Graph1
...
public class OrderOfCharacters
{
    ...
    {
        // Create a Graph1 with 'aplha' edges
        Graph1 Graph1 = new Graph1(alpha);
        ...
        for (int i = 0; i < words.length - 1; i++)
        {
            ...
            for (int j = 0; j < Math.min(word1.length(), word2.length()); j++)
            {
                ...
                {
                    Graph1.addEdge(word1.charAt(j) - 'a', word2.charAt(j)- 'a');
                    break;
                }
            }
        }

        // Print topological sort of the above created Graph1
